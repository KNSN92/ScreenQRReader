...
export async function validateQRCode(text: string, image: Uint8Array): Promise<ValidateQRCodeResponse> {
  return await invoke("validate_qrcode", { payload: { text, image } });
}
